...
It is a compact but complete trading platform that demonstrates both halves of the
job:
...
tests/            # 40 tests: events, execution, accounting, metrics, parity, no-lookahead
```
